...
<section class="p-15">
    ...
    <section class="container mx-auto">
            ...
            <table class="w-full border-collapse rounded-lg table-fixed">
                ...
                <tbody>
                    <tr class="bg-white even:bg-gray-100">
                        ...
                        <td class="px-6 py-4 border-b border-gray-300">
                            <div class="flex gap-2">
                                <button onclick="openForm('editar', {id:1, nombre:'Jose Matias', anio:'2025', seccion:'A', especialidad:'Matemáticas', estado:'Activo'})"
                                    class="px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 transition">Editar</button> <button class="px-3 py-1 bg-red-500 text-white rounded hover:bg-red-600 transition">Eliminar</button>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr class="bg-white even:bg-gray-100">
                        ...
                        <td class="px-6 py-4 border-b border-gray-300">
                            <div class="flex gap-2">
                                <button onclick="openForm('editar', {id:2, nombre:'Maria Lopez', anio:'2025', seccion:'B', especialidad:'Ciencias', estado:'Activo'})"
                                    class="px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 transition">Editar</button>
                                <button onclick="openForm('eliminar', {id:2, nombre:'Maria Lopez'})"
                    ...
                    <tr class="bg-white even:bg-gray-100">
                        ...
                        <td class="px-6 py-4 border-b border-gray-300">
                            <div class="flex gap-2">
                                <button onclick="openForm('editar', {id:3, nombre:'Karla', anio:'2024', seccion:'C', especialidad:'Historia', estado:'Inactivo'})"
                                    class="px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 transition">Editar</button>
                                <button onclick="openForm('eliminar', {id:3, nombre:'Karla'})"
                                    class="px-3 py-1 bg-red-500 text-white rounded hover:bg-red-600 transition">Eliminar</button>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr class="bg-white even:bg-gray-100">
                        ...
                        <td class="px-6 py-4 border-b border-gray-300">
                            <div class="flex gap-2">
                                <button onclick="openForm('editar', {id:4, nombre:'Brian', anio:'2023', seccion:'A', especialidad:'Lengua', estado:'Activo'})"
                                    class="px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 transition">Editar</button>
                                <button onclick="openForm('eliminar', {id:4, nombre:'Brian'})"
                                    class="px-3 py-1 bg-red-500 text-white rounded hover:bg-red-600 transition">Eliminar</button>
                            </div>
                        </td>
                    </tr>
        ...
        <div class="block lg:hidden space-y-3 overflow-auto h-[550px]">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                <!-- Parte visible (datos importantes) -->
                ...
                <div id="accordion1" class="hidden border-t border-gray-200">
                    <div class="p-4 bg-gray-50">
                        ...
                        <div class="flex gap-2 mt-4">
                            ...
                            <button onclick="openForm('eliminar', {id:1, nombre:'Jose Matias'})"
    ...
    <script>
        ...
        function openForm(modo, data = null) {
            ...
            document.getElementById('formTitle').textContent = modo === 'editar' ? 'Editar Alumno' : 'Añadir Alumno';
